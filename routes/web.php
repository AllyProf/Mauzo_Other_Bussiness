...
Route::middleware(['auth', 'check.user.active', 'check.subscription'])->group(function () {
    ...
    Route::get('/items/barcodes', [App\Http\Controllers\ItemController::class, 'barcodesIndex'])->name('items.barcodes.index');
    Route::get('/items/barcodes/print-bulk', [App\Http\Controllers\ItemController::class, 'printBarcodesBulk'])->name('items.barcodes.print-bulk');
