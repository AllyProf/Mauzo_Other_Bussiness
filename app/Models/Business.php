...
class Business extends Model
{
    ...
    public static function defaultAutomationSettings(): array
    {
        return [
            ...
            'sms_staff_handover_submitted_manager' => true,
            ...
            'email_sales_report_weekly' => false,
            'email_sales_report_monthly' => false,
            'email_sales_report_send_time' => '18:00',
            'email_sales_report_weekly_day' => 1,
            'email_sales_report_monthly_day' => 1,
            'email_sales_report_recipients' => '',
            'email_sales_report_skip_empty' => true,
            'email_sales_report_manager_digest' => true,
            'email_sales_report_retry_queue' => [],
            ...
            'email_staff_handover_submitted_manager' => true,
    ...
    public static function defaultStaffSmsTemplates(): array
    {
        return [
            ...
            'sms_staff_template_handover_submitted_owner' => '{business}: {submitter} closed shift {date}. {sales_count} sales, gross TZS {gross_sales}, handover TZS {net_amount}. Profit TZS {profit}.{expense_note} Circulation TZS {circulation_return}.{payment_suffix}{cancelled_note} Verify in Daily Reconciliation.',
            'sms_staff_template_handover_submitted_manager' => '{business}: {submitter} closed shift {date}. {sales_count} sales, gross TZS {gross_sales}, handover TZS {net_amount}. Profit TZS {profit}.{expense_note} Circulation TZS {circulation_return}.{payment_suffix}{cancelled_note}',
    ...
    public static function staffSmsTemplateLabels(): array
    {
        return [
            ...
            'sms_staff_template_handover_submitted_owner' => 'Shift closed — sales summary (owner)',
            'sms_staff_template_handover_submitted_manager' => 'Shift closed — sales summary (manager)',
